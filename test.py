...
# CREATE TABLE game_platform (title CHAR(64), platform_name CHAR(64), PRIMARY KEY(title, platform_name), FOREIGN KEY(title) REFERENCES game_info(title) ON DELETE CASCADE, FOREIGN KEY(platform_name) REFERENCES platform(platform_name) ON DELETE CASCADE)

# CREATE TABLE genre (genre_name CHAR(64) PRIMARY KEY)
# CREATE TABLE game_genre (title CHAR(64), genre_name CHAR(64), PRIMARY KEY(title, genre_name), FOREIGN KEY(title) REFERENCES game_info(title) ON DELETE CASCADE, FOREIGN KEY(genre_name) REFERENCES genre(genre_name) ON DELETE CASCADE)

# CREATE TABLE store (store_name CHAR(64) PRIMARY KEY)
# CREATE TABLE game_store (title CHAR(64), store_name CHAR(64), price VARCHAR(10), PRIMARY KEY(title, store_name), FOREIGN KEY(title) REFERENCES game_info(title) ON DELETE CASCADE, FOREIGN KEY(store_name) REFERENCES store(store_name) ON DELETE CASCADE)
