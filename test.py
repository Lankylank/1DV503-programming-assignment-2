...
# CREATE TABLE game_platform (title CHAR(64), platform_name CHAR(64), PRIMARY KEY(title, platform_name), FOREIGN KEY(title) REFERENCES game_info(title) ON NO ACTION, FOREIGN KEY(platform_name) REFERENCES platform(platform_name) ON ACTION)

# CREATE TABLE genre (genre_name CHAR(64) PRIMARY KEY)
# CREATE TABLE game_genre (title CHAR(64), genre_name CHAR(64), PRIMARY KEY(title, genre_name), FOREIGN KEY(title) REFERENCES game_info(title) ON NO ACTION, FOREIGN KEY(genre_name) REFERENCES genre(genre_name) ON NO ACTION)
